...
_H_ADAPTIVE = ("Адаптивное управление — управление светофорным объектом путём непрерывной "
               ...
               "от параметров движения, определяемых детекторами транспорта или иными способами. "
               "[ГОСТ Р 71096-2023]\n\n"
               "В расчётах: доля светофорных объектов с адаптивным регулированием "
               "от общего числа в агломерации.")

_H_DISPATCH = ("Диспетчерское управление — способ управления светофорной сигнализацией "
               "и позициями управляемых знаков оператором. [Руководство по АССУД]\n\n"
               "В расчётах: доля светофорных объектов с диспетчерским регулированием "
               "от общего числа в агломерации.")

_H_DELAY = ("Задержка ТС — потеря времени в движении транспортных средств; "
            "средняя задержка ТС на участке дороги. [ГОСТ Р 70044-2022]")

_H_STOP = ("Остановка ТС — преднамеренное прекращение движения ТС на время до 5 минут, "
           "а также на большее, если необходимо для посадки/высадки пассажиров "
           "или загрузки/разгрузки ТС. [ПДД, Постановление Правительства РФ № 1090]")

_H_INTENSITY = ("Суточная интенсивность — количество ТС, проходящих через поперечное сечение "
                "дороги за одни сутки (24 часа), суммарно в обоих направлениях. [ГОСТ 32965-2014]")

_H_SPEED = ("Средняя скорость ТС — отношение пройденного пути к общему затраченному времени "
            "(включая остановки). [ГОСТ 32965-2014]")

_H_PUNKT = ("Пункт учёта (стационарный) — место на автомобильной дороге, предназначенное "
            "для определения интенсивности движения на регулярной основе с преимущественным "
            "использованием автоматизированного метода подсчёта. [ГОСТ 32965-2014]")

_H_GLONASS = ("Бортовые навигационно-связные терминалы ГЛОНАСС/GPS — мобильное связное "
              "оборудование на ТС городского пассажирского транспорта для передачи "
              "навигационной и телематической информации по сетям подвижной радиосвязи. "
              "[ГОСТ Р 57187-2016]")
...
_H_PUNCT = ("Пунктуальность НГПТ — показатель качества транспортного обслуживания: "
            "насколько точно транспортные средства следуют утверждённому расписанию. "
            "[Приказ Минтранса России от 30.12.2021 № 482]")

_H_PASSFLOW = ("Пассажиропоток — движение пассажиров в одном направлении на участке "
               "транспортной сети за промежуток времени; число пассажиров, перевезённых "
               "за единицу времени (час, сутки, месяц и т. д.). [ГОСТ 32965-2014]")
...
# ══════════════════════════════════════════════════════════════════
    ...
    with t4:
        ...
        st.caption("Примечание: своевременность ликвидации последствий выявленных инцидентов определяется в соответствии с внутренними регламентами уполномоченного органа, занимающегося управлением дорожным движением.")
        w4=(j_w/k_w)*100
