...
# ══════════════════════════════════════════════════════════════════
    ...
    with col_radar:
        st.markdown("<small style='color:rgba(49,51,63,0.6)'>Диаграмма-паук показывает баллы каждой подсистемы (0–100 %).<br>Чем ближе фигура к внешней границе — тем лучше.</small>", unsafe_allow_html=True)
