...
# ══════════════════════════════════════════════════════════════════
    ...
    with col_radar:
        st.markdown("<small style='color:rgba(49,51,63,0.6);line-height:1.05'>Диаграмма-паук показывает баллы каждого комплексного показателя (0–100 %). Чем ближе фигура к внешней границе, тем лучше.</small>", unsafe_allow_html=True)
